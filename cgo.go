...
// #cgo CXXFLAGS: -fno-rtti -std=c++17 -DV8_COMPRESS_POINTERS -DV8_31BIT_SMIS_ON_64BIT_ARCH -I${SRCDIR}/deps/include -Wall -DV8_ENABLE_SANDBOX
...
// #cgo windows,amd64 LDFLAGS: -L${SRCDIR}/deps/windows_x86_64 -lv8 -ldbghelp -lwinmm -lshlwapi -ladvapi32
// #cgo windows,arm64 LDFLAGS: -L${SRCDIR}/deps/windows_arm64 -lv8 -ldbghelp -lwinmm -lshlwapi -ladvapi32
import "C"
